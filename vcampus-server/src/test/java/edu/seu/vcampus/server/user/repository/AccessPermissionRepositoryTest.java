...
import static edu.seu.vcampus.common.user.UserRole.LIBRARY_ADMIN;
...
class AccessPermissionRepositoryTest {
    ...
    void loadsRolePermissionsFromRolePermissionTable() {
        ...
        Set<String> libraryAdministratorPermissions = transactions.inTransaction(connection ->
                permissions.findByRole(connection, LIBRARY_ADMIN));
