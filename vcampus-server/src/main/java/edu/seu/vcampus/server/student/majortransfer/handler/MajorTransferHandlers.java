...
public final class MajorTransferHandlers {
    ...
    public static final List<String> ADMIN_COMMANDS = List.of(
            ...
            "MAJOR_TRANSFER_IMPORT_SCORES", "MAJOR_TRANSFER_GET_OPTION_READINESS",
            "MAJOR_TRANSFER_FINALIZE_OPTION", "MAJOR_TRANSFER_EFFECTIVE_OPTION",
            "MAJOR_TRANSFER_ROLLBACK_OPTION", "MAJOR_TRANSFER_CANCEL");
