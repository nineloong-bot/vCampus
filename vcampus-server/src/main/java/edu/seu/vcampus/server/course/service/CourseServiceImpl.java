...
public final class CourseServiceImpl implements CourseService, CourseQueryPort {
    ...
    private OfferingSummary summary(Connection c,Offering o,edu.seu.vcampus.server.course.repository.Course course){var quota=repository.findRetakeQuota(c,o.offeringId());return new OfferingSummary(o.offeringId(),o.termId(),o.courseId(),course.courseCode(),course.courseName(),o.teacherUserId(),o.className(),o.capacity(),o.enrolledCount(),quota.capacity(),quota.enrolledCount(),o.offeringStatus(),o.rowVersion(),toScheduleItems(repository.findSchedules(c,o.offeringId()),o,course));}
