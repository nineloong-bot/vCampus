...
public final class CourseHandlers {
 ...
 private static String userMessage(String code){return switch(code){case "COMMON_CONCURRENT_MODIFICATION"->"数据已被其他操作修改，请刷新后重试";case "COMMON_FORBIDDEN"->"没有执行该操作的权限，请重新登录或联系管理员";case "COURSE_OFFERING_FULL"->"教学班容量已满，请选择其他教学班";case "COURSE_OFFERING_HAS_ENROLLMENTS"->"已有学生选课，不能修改所属学期、课程或上课安排";case "COURSE_SCHEDULE_CONFLICT"->"所选教学班与当前课表冲突，请调整选择";case "COURSE_DUPLICATE_ENROLLMENT"->"本学期已选择该课程，请先查看当前选课";case "COURSE_ENROLLMENT_NOT_OPEN"->"当前不在选课时间内，请查看开放时间";case "COURSE_DROP_NOT_OPEN"->"当前不在可退选时间内，请查看选课与退改选开放时间";case "COURSE_ADJUSTMENT_NOT_OPEN"->"当前不在退改补时间内，请查看调整时间";case "COURSE_STUDENT_INELIGIBLE"->"当前学籍状态不允许选课，请联系教务人员";case "COURSE_ENROLLMENT_NOT_ACTIVE"->"选课记录已失效，请刷新后重试";case "COURSE_CHANGE_TARGET_INVALID"->"目标教学班不可用于改选，请重新选择";case "COURSE_RETAKE_NOT_ELIGIBLE"->"未找到不通过的修读记录，暂不能重修";case "COURSE_OUTCOME_IMPORT_INVALID"->"导入内容无效或来源冲突，请核对后重试";default->"操作未完成，请刷新数据后重试";};}
}
