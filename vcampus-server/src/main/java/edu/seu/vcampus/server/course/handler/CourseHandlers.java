...
public final class CourseHandlers {
 ...
 private static String userMessage(String code){return switch(code){case "COMMON_FORBIDDEN"->"没有执行该操作的权限";case "COURSE_OFFERING_FULL"->"教学班容量已满";case "COURSE_SCHEDULE_CONFLICT"->"所选教学班与当前课表冲突";case "COURSE_DUPLICATE_ENROLLMENT"->"本学期已选择该课程";case "COURSE_ENROLLMENT_NOT_OPEN"->"当前不在选课时间内";case "COURSE_ADJUSTMENT_NOT_OPEN"->"当前不在退改补时间内";default->"操作未完成，请检查后重试";};}
}
