...
public final class CourseComposition {
 ...
 /** Composes course infrastructure with the application-owned cross-module lock manager. */
 public static CourseComposition create(ConnectionProvider database,CourseAuthorizationGateway authorization,CourseStudentGateway students,Clock clock,ResourceLockManager locks){return new CourseComposition(Objects.requireNonNull(database),Objects.requireNonNull(authorization),Objects.requireNonNull(students),Objects.requireNonNull(clock),Objects.requireNonNull(locks));}
