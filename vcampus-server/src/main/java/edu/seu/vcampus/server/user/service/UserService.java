...
public interface UserService {
    ...
    /** Retains the course integration's actor-aware role update overload. */
    default UserView updateRole(String actorUserId, UpdateUserRoleCommand command) {
        return updateRole(actorUserId, command, null);
    }
    ...
    /** Retains the course integration's actor-aware status update overload. */
    default UserView changeStatus(String actorUserId, ChangeUserStatusCommand command) {
        return changeStatus(actorUserId, command, null);
    }
