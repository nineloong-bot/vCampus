...
WHERE studentId IN (
  ...
  AND politicalStatus IS NULL;

-- ── Number sequences ──
UPDATE tblNumberSequence SET currentValue = 112
WHERE sequenceKey = 'CAMPUS_CARD_GLOBAL' AND currentValue < 112;
UPDATE tblNumberSequence SET currentValue = 29
WHERE sequenceKey = 'STUDENT_NUMBER:090:23:1' AND currentValue < 29;
