...
public final class MainFrame extends JFrame {
    ...
    public MainFrame(UserView user, ClientConnection connection,
        ...
        navigation = new PermissionNavigation(pageNavigator::show, user == null ? null : user.role());
        content.setBackground(UiColors.BACKGROUND_PAGE);
        MainFramePageSetup.registerInitialPages(pageNavigator, navigation, user, connection, students);
