...
/** Form layout and submit-button styling for the contact dialog segments. */
abstract class UpdateContactDialogForm extends UpdateContactDialogBase {

    UpdateContactDialogForm(Window owner, StudentClientService students,
