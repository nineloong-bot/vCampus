...
/** Conflict recovery refresh flow for the enrollment change segments. */
abstract class EnrollmentChangeDialogRefreshing extends EnrollmentChangeDialogSaving {

    EnrollmentChangeDialogRefreshing(Window owner, StudentClientService students,
