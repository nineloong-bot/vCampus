...
/** Immutable search query, filter visibility, and viewport position. */
public record SearchViewState(ProductSearchQuery query, boolean filtersExpanded, int scrollY) {
