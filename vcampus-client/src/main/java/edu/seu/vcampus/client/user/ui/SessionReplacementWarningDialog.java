...
final class SessionReplacementWarningDialog extends JDialog {
    ...
    SessionReplacementWarningDialog(Window owner, Runnable onFinished) {
        super(owner, "登录安全提醒", Dialog.ModalityType.MODELESS);
