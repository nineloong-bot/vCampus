...
final class CartItemCard extends JPanel {
    final JButton update; final JButton remove;
    CartItemCard(CartItemView item, ShopUiKit kit, Runnable open, IntConsumer updateQuantity, Runnable removeItem) {
        ...
        remove = kit.secondaryButton("cart.remove-" + item.cartItemId(), "删除");
