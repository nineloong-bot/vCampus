...
public final class MyStudentProfilePanel extends JPanel {
    ...
    private void buildPage() {
        ...
        JPanel contact = group("联系方式"); addField(contact, "邮箱", "student.profile.email"); addField(contact, "电话", "student.profile.phone");
        ...
        editButton = new JButton("编辑"); editButton.setName("student.profile.edit"); editButton.getAccessibleContext().setAccessibleName("编辑学籍档案"); editButton.setEnabled(false);
