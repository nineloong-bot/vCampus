...
/** Package-private confirmation boundary for student password initialization. */
final class StudentPasswordResetConfirmationDialog extends JDialog {
    StudentPasswordResetConfirmationDialog(Window owner, Runnable onConfirmed) {
        ...
        JLabel question = new JLabel(
                "将该学生密码初始化为系统默认密码，学生下次登录必须修改密码。是否继续？");
        ...
        JButton cancel = button("取消", "studentReset.cancel");
        JButton confirm = button("初始化密码", "studentReset.confirm");
    ...
    private void installEscape(JButton cancel) {
        String action = "cancel-student-password-reset";
