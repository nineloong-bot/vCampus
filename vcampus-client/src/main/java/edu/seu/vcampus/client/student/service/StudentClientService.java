...
public final class StudentClientService {
    ...
    public CompletableFuture<ResponseBody<MajorTransferCollegeReadinessView>> getTransferBatchReadiness(String batchId) { return sendAsync("MAJOR_TRANSFER_GET_BATCH_READINESS", new EntityIdRequest(batchId)); }
    public CompletableFuture<ResponseBody<MajorTransferBatchReviewResult>> finalizeTransferBatch(FinalizeMajorTransferBatchCommand value) { return sendAsync("MAJOR_TRANSFER_FINALIZE_BATCH", value); }
    public CompletableFuture<ResponseBody<MajorTransferBatchEffectResult>> effectiveTransferBatch(EffectiveMajorTransferBatchCommand value) { return sendAsync("MAJOR_TRANSFER_EFFECTIVE_BATCH", value); }
    public CompletableFuture<ResponseBody<MajorTransferBatchRollbackResult>> rollbackTransferBatch(RollbackMajorTransferBatchCommand value) { return sendAsync("MAJOR_TRANSFER_ROLLBACK_BATCH", value); }
