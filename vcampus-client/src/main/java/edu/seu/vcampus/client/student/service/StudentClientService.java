...
public final class StudentClientService {
    ...
    public CompletableFuture<ResponseBody<MajorTransferOptionReadinessView>> getTransferOptionReadiness(String optionId) { return sendAsync("MAJOR_TRANSFER_GET_OPTION_READINESS", new EntityIdRequest(optionId)); }
    public CompletableFuture<ResponseBody<MajorTransferOptionReviewResult>> finalizeTransferOption(FinalizeMajorTransferOptionCommand value) { return sendAsync("MAJOR_TRANSFER_FINALIZE_OPTION", value); }
    public CompletableFuture<ResponseBody<MajorTransferOptionEffectResult>> effectiveTransferOption(EffectiveMajorTransferOptionCommand value) { return sendAsync("MAJOR_TRANSFER_EFFECTIVE_OPTION", value); }
    public CompletableFuture<ResponseBody<MajorTransferOptionRollbackResult>> rollbackTransferOption(RollbackMajorTransferOptionCommand value) { return sendAsync("MAJOR_TRANSFER_ROLLBACK_OPTION", value); }
