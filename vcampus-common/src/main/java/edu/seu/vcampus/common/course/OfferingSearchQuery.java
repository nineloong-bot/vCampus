...
public record OfferingSearchQuery(String termId,String keyword,String dayOfWeek,Boolean availableOnly,int page,int pageSize) implements Serializable {
 ...
 public OfferingSearchQuery { if(page<0||pageSize<1||pageSize>100||(long)page*pageSize+pageSize>Integer.MAX_VALUE) throw new IllegalArgumentException("invalid page"); }
}
