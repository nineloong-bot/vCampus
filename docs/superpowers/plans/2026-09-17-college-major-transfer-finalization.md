...
- [ ] **Step 3: Add schema tables and focused repository methods**
...
- [ ] **Step 3: Implement immutable protocol records**
...
- [ ] **Step 3: Implement the batch transition guard**
...
- [ ] **Step 1: Write failing multi-college and preparation tests**
...
- [ ] **Step 3: Scope readiness and locking by target college**
...
- [ ] **Step 4: Implement review preparation**
...
- [ ] **Step 5: Implement non-destructive rollback**
...
- [ ] **Step 6: Implement prepared effectuation**
...
- [ ] **Step 7: Block options and student applications after college effectuation**
...
- [ ] **Step 8: Run focused service tests and verify GREEN**
...
- [ ] **Step 2: Run handler and UI tests and verify RED**
...
- [ ] **Step 3: Implement target-college batch authorization**
...
- [ ] **Step 4: Wire distinct commands and result types**
...
- [ ] **Step 5: Add rollback and state-driven controls**
...
- [ ] **Step 6: Run handler and UI tests and verify GREEN**
...
- [ ] **Step 3: Generate lifecycle rows and update validators**
...
- [ ] **Step 4: Run generator and database validators**
...
- [ ] **Step 5: Replace the release database only after validation**
