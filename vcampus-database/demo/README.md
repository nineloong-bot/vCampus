...
`full-test-data/tools/generate.py` 会生成 9 个学院、16 个专业、2400 名基础学生，
并额外生成 240 名计算机学院大一转专业场景。每个专业/年级培养方案覆盖 8 个学期，
每学期均为 5 门、每门 3 学分，共 15 学分；课程目录包含 160 门课程，配套生成
秋季和春季教学班，可直接用于选课、退改选和重修测试。
